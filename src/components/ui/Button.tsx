  ...
  'inline-flex items-center justify-center gap-2 font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-2 border-[var(--color-primary-300)] text-[var(--color-primary-600)] bg-transparent hover:bg-[var(--color-primary-50)] hover:border-[var(--color-primary-400)] focus-visible:ring-[var(--color-primary-400)] dark:border-[var(--color-primary-700)] dark:text-[var(--color-primary-300)] dark:hover:bg-[var(--color-primary-950)] dark:hover:border-[var(--color-primary-500)]',
        ghost:
